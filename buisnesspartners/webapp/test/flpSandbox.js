		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Suppliers",
									"targetURL": "#nsbuisnesspartners-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsbuisnesspartners-display": {
								"semanticObject": "nsbuisnesspartners",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.buisnesspartners",
									"url": sap.ui.require.toUrl("ns/buisnesspartners")
								}
							}
						}
					}
